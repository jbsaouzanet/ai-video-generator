...
import captions from './subtitles/wide33.json';
...
export const RocketModWeaponDetection: React.FC = () => (
	<FormatProvider format={WIDE}>
		<TLProvider tl={WIDE33}>
			<Stage33 subtitles={{captions, y: 976, size: 42, maxWidth: 1500}} scenes={{hook: Scene1Hook, profiles: Scene2Profiles, detect: Scene3Detect, auto: Scene4Auto, docs: Scene5Docs, end: Scene6End}} />
		</TLProvider>
	</FormatProvider>
);
